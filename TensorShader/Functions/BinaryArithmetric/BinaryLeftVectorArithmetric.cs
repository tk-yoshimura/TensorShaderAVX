...
namespace TensorShader {
    ...
    public partial class Tensor {
        /// <summary>2項演算</summary>
        internal static Tensor BinaryLeftVectorArithmetric(Tensor x1, Tensor x2, Operators.BinaryArithmetric.BinaryLeftVectorArithmetric binary_operator) {
            Function function = new Functions.BinaryLeftVectorArithmetric.BinaryLeftVectorArithmetric(binary_operator);
...
namespace TensorShader.Functions.BinaryLeftVectorArithmetric {
    /// <summary>2項演算</summary>
    internal class BinaryLeftVectorArithmetric : Function {
        ...
        public override void CheckInputShapes(params Shape[] inshapes) {
            ...
            for (int i = 0; i < inshapes[0].Ndim; i++) {
