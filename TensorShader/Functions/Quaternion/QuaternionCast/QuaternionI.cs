...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode QuaternionI(VariableNode x) {
            Function function = new Functions.Quaternion.QuaternionI();
    ...
    public partial class Tensor {
        /// <summary>四元数第2成分</summary>
        public static Tensor QuaternionI(Tensor x) {
            Function function = new Functions.Quaternion.QuaternionI();
...
namespace TensorShader.Functions.Quaternion {
    /// <summary>四元数第2成分</summary>
    internal class QuaternionI : Function {
        ...
        internal override (Tensor[] tensors, Operator ope) GenerateOperator(Tensor[] intensors, Tensor[] outtensors) {
            ...
            return (new Tensor[] { intensor, outtensor },
                    new Operators.QuaternionCast.QuaternionI(intensor.Shape));
        }
    }
}
