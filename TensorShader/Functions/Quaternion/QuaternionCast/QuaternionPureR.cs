...
namespace TensorShader {
    public abstract partial class VariableNode {
        /// <summary>四元数純第1成分</summary>
        public static VariableNode QuaternionPureR(VariableNode X) {
            Function function = new Functions.Quaternion.QuaternionPureR();
    ...
    public partial class Tensor {
        /// <summary>四元数純第1成分</summary>
        public static Tensor QuaternionPureR(Tensor X) {
            Function function = new Functions.Quaternion.QuaternionPureR();
...
namespace TensorShader.Functions.Quaternion {
    /// <summary>四元数純第1成分</summary>
    internal class QuaternionPureR : Function {
        /// <summary>コンストラクタ</summary>
        public QuaternionPureR()
        ...
        internal override (Tensor[] tensors, Operator ope) GenerateOperator(Tensor[] intensors, Tensor[] outtensors) {
            ...
            return (new Tensor[] { intensor, outtensor },
                    new Operators.QuaternionCast.QuaternionPureR(intensor.Shape));
        }
    }
}
