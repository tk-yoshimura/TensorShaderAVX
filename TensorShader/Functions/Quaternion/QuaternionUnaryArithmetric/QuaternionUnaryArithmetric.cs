...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        internal static VariableNode QuaternionUnaryArithmetric(VariableNode x, Operators.QuaternionUnaryArithmetric.QuaternionUnaryArithmetric arithmetric) {
            Function function = new Functions.QuaternionArithmetric.QuaternionUnaryArithmetric(arithmetric);
    ...
    public partial class Tensor {
        /// <summary>四元数1項演算</summary>
        internal static Tensor QuaternionUnaryArithmetric(Tensor x, Operators.QuaternionUnaryArithmetric.QuaternionUnaryArithmetric arithmetric) {
            Function function = new Functions.QuaternionArithmetric.QuaternionUnaryArithmetric(arithmetric);
...
namespace TensorShader.Functions.QuaternionArithmetric {
    /// <summary>四元数1項演算</summary>
    internal class QuaternionUnaryArithmetric : Function {
        private readonly Operator arithmetric;

        /// <summary>コンストラクタ</summary>
        public QuaternionUnaryArithmetric(Operators.QuaternionUnaryArithmetric.QuaternionUnaryArithmetric arithmetric)
