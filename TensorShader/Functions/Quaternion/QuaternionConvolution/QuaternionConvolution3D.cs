...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode QuaternionConvolution3D(VariableNode x, VariableNode w, int stride, bool gradmode = false) {
            Function function =
                new Functions.QuaternionConvolution.QuaternionConvolution3D(x.Shape, w.Shape, stride, gradmode);
    ...
    public partial class Tensor {
        /// <summary>四元数3次元畳み込み</summary>
        public static Tensor QuaternionConvolution3D(Tensor x, Tensor w, int stride, bool gradmode = false) {
...
namespace TensorShader.Functions.QuaternionConvolution {
    ...
    internal class QuaternionConvolution3D : Function {
        ...
        public QuaternionConvolution3D(Shape inshape, Shape kernelshape, int stride, bool gradmode) :
