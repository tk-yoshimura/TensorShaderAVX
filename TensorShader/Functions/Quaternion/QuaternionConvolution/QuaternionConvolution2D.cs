...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode QuaternionConvolution2D(VariableNode x, VariableNode w, int stride, bool gradmode = false) {
            Function function =
                new Functions.QuaternionConvolution.QuaternionConvolution2D(x.Shape, w.Shape, stride, gradmode);
    ...
    public partial class Tensor {
        /// <summary>四元数2次元畳み込み</summary>
        public static Tensor QuaternionConvolution2D(Tensor x, Tensor w, int stride, bool gradmode = false) {
            Functions.QuaternionConvolution.QuaternionConvolution2D function =
                new Functions.QuaternionConvolution.QuaternionConvolution2D(x.Shape, w.Shape, stride, gradmode);
...
namespace TensorShader.Functions.QuaternionConvolution {
    /// <summary>四元数2次元畳み込み</summary>
    internal class QuaternionConvolution2D : Function {
        ...
        public QuaternionConvolution2D(Shape inshape, Shape kernelshape, int stride, bool gradmode) :
            ...
            this.OutShape = Shape.Map2D(kernelshape.OutChannels * 4, outwidth, outheight, inshape.Batch);
        ...
        internal override (Tensor[] tensors, Operator ope) GenerateOperator(Tensor[] intensors, Tensor[] outtensors) {
            ...
            return (new Tensor[] { intensors[0], intensors[1], outtensors[0] },
                    new Operators.QuaternionConvolution.QuaternionConvolution2D(
