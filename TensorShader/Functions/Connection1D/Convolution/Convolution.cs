...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode Convolution1D(VariableNode x, VariableNode w, int stride) {
            Function function =
                new Functions.Connection1D.Convolution(x.Shape, w.Shape, stride);
    ...
    public partial class Tensor {
        /// <summary>1次元畳み込み</summary>
        public static Tensor Convolution1D(Tensor x, Tensor w, int stride) {
            Functions.Connection1D.Convolution function =
                new Functions.Connection1D.Convolution(x.Shape, w.Shape, stride);
...
namespace TensorShader.Functions.Connection1D {
    ...
    internal class Convolution : Function {
        ...
        public Convolution(Shape inshape, Shape kernelshape, int stride) :
            ...
            this.OutShape = Shape.Map1D(kernelshape.OutChannels, outwidth, inshape.Batch);
        ...
        internal override (Tensor[] tensors, Operator ope) GenerateOperator(Tensor[] intensors, Tensor[] outtensors) {
            ...
            return (new Tensor[] { intensors[0], intensors[1], outtensors[0] },
                    new Operators.Connection1D.Convolution(
                        InShape.Width,
