...
namespace TensorShader {
    public abstract partial class VariableNode {
        /// <summary>1次元最近傍補間</summary>
        /// <remarks>倍率2固定</remarks>
        public static VariableNode NeighborZoom1D(VariableNode x) {
            Function function =
    ...
    public partial class Tensor {
        /// <summary>1次元最近傍補間</summary>
        /// <remarks>倍率2固定</remarks>
        public static Tensor NeighborZoom1D(Tensor x) {
            Function function =
                new Functions.Connection1D.NeighborZoom();
    ...
    internal class NeighborZoom : Function {
        ...
        internal override (Tensor[] tensors, Operator ope) GenerateOperator(Tensor[] intensors, Tensor[] outtensors) {
            ...
            return (new Tensor[] { intensors[0], outtensors[0] },
                    new Operators.Connection1D.NeighborZoom(
