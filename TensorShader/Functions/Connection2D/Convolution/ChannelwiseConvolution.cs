...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode ChannelwiseConvolution2D(VariableNode x, VariableNode w, int stride) {
            Function function =
                new Functions.Connection2D.ChannelwiseConvolution(x.Shape, w.Shape, stride);
    ...
    public partial class Tensor {
        /// <summary>チャネルごとの2次元畳み込み</summary>
        public static Tensor ChannelwiseConvolution2D(Tensor x, Tensor w, int stride) {
            Functions.Connection2D.ChannelwiseConvolution function =
                new Functions.Connection2D.ChannelwiseConvolution(x.Shape, w.Shape, stride);
    ...
    internal class ChannelwiseConvolution : Function {
        ...
        internal override (Tensor[] tensors, Operator ope) GenerateOperator(Tensor[] intensors, Tensor[] outtensors) {
            ...
            return (new Tensor[] { intensors[0], intensors[1], outtensors[0] },
                    new Operators.Connection2D.ChannelwiseConvolution(
