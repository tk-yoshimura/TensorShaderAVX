...
namespace TensorShader.Functions.Connection2D {
    ...
    internal class ChannelwiseKernelProduct : Function {
        ...
        public ChannelwiseKernelProduct(Shape inshape, Shape outshape, int kwidth, int kheight, int stride) :
            ...
            this.KernelShape = Shape.Kernel2D(inshape.Channels, 1, kwidth, kheight);
            this.Stride = stride;
        }
        ...
        internal override (Tensor[] tensors, Operator ope) GenerateOperator(Tensor[] intensors, Tensor[] outtensors) {
            ...
            return (new Tensor[] { intensors[0], intensors[1], outtensors[0] },
                    new Operators.Connection2D.ChannelwiseKernelProduct(
