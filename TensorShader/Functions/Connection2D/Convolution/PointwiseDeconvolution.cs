...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode PointwiseDeconvolution2D(VariableNode x, VariableNode w) {
            Function function =
                new Functions.Connection2D.PointwiseDeconvolution(x.Shape, w.Shape);
    ...
    public partial class Tensor {
        /// <summary>ポイントごとの2次元逆畳み込み</summary>
        public static Tensor PointwiseDeconvolution2D(Tensor x, Tensor w) {
            Functions.Connection2D.PointwiseDeconvolution function =
                new Functions.Connection2D.PointwiseDeconvolution(x.Shape, w.Shape);
...
namespace TensorShader.Functions.Connection2D {
    ...
    internal class PointwiseDeconvolution : Function {
        ...
        public PointwiseDeconvolution(Shape inshape, Shape kernelshape) :
            ...
            this.OutShape = Shape.Map2D(kernelshape.InChannels, inshape.Width, inshape.Height, inshape.Batch);
        ...
        internal override (Tensor[] tensors, Operator ope) GenerateOperator(Tensor[] intensors, Tensor[] outtensors) {
            ...
            return (new Tensor[] { intensors[0], intensors[1], outtensors[0] },
                    new Operators.Connection2D.PointwiseDeconvolution(
