...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode ChannelwiseDeconvolution2D(VariableNode x, VariableNode w, int stride, Shape outshape = null) {
            if (outshape == null) {
            ...
            Function function =
                new Functions.Connection2D.ChannelwiseDeconvolution(outshape, w.Shape, stride);
    ...
    public partial class Tensor {
        /// <summary>チャネルごとの2次元逆畳み込み</summary>
        public static Tensor ChannelwiseDeconvolution2D(Tensor x, Tensor w, int stride, Shape outshape = null) {
            if (outshape == null) {
                int outwidth = (x.Shape.Width - 1) * stride + w.Shape.Width;
                int outheight = (x.Shape.Height - 1) * stride + w.Shape.Height;
...
namespace TensorShader.Functions.Connection2D {
    ...
    internal class ChannelwiseDeconvolution : Function {
        ...
        public ChannelwiseDeconvolution(Shape outshape, Shape kernelshape, int stride) :
            ...
            this.InShape = Shape.Map2D(outshape.Channels, inwidth, inheight, outshape.Batch);
