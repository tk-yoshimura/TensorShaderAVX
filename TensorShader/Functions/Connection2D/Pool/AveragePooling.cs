...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode AveragePooling2D(VariableNode x, int stride) {
            Function function =
                new Functions.Connection2D.AveragePooling(stride);
    ...
    public partial class Tensor {
        /// <summary>2次元平均値プーリング</summary>
        public static Tensor AveragePooling2D(Tensor x, int stride) {
            Function function =
                new Functions.Connection2D.AveragePooling(stride);
    ...
    internal class AveragePooling : Function {
        ...
        internal override (Tensor[] tensors, Operator ope) GenerateOperator(Tensor[] intensors, Tensor[] outtensors) {
            ...
            return (new Tensor[] { intensors[0], outtensors[0] },
                    new Operators.Connection2D.AveragePooling(
