...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode ComplexConvolution1D(VariableNode x, VariableNode w, int stride, bool gradmode = false) {
            Function function =
                new Functions.ComplexConvolution.ComplexConvolution1D(x.Shape, w.Shape, stride, gradmode);
    ...
    public partial class Tensor {
        /// <summary>複素1次元畳み込み</summary>
        public static Tensor ComplexConvolution1D(Tensor x, Tensor w, int stride, bool gradmode = false) {
            Functions.ComplexConvolution.ComplexConvolution1D function =
                new Functions.ComplexConvolution.ComplexConvolution1D(x.Shape, w.Shape, stride, gradmode);
...
namespace TensorShader.Functions.ComplexConvolution {
    /// <summary>複素1次元畳み込み</summary>
    internal class ComplexConvolution1D : Function {
        ...
        public ComplexConvolution1D(Shape inshape, Shape kernelshape, int stride, bool gradmode) :
            ...
            this.OutShape = Shape.Map1D(kernelshape.OutChannels * 2, outwidth, inshape.Batch);
        ...
        internal override (Tensor[] tensors, Operator ope) GenerateOperator(Tensor[] intensors, Tensor[] outtensors) {
            ...
            return (new Tensor[] { intensors[0], intensors[1], outtensors[0] },
                    new Operators.ComplexConvolution.ComplexConvolution1D(
                        InShape.Width,
