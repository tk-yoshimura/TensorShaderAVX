...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode ComplexConvolution3D(VariableNode x, VariableNode w, int stride, bool gradmode = false) {
            Function function =
                new Functions.ComplexConvolution.ComplexConvolution3D(x.Shape, w.Shape, stride, gradmode);
    ...
    public partial class Tensor {
        /// <summary>複素3次元畳み込み</summary>
        public static Tensor ComplexConvolution3D(Tensor x, Tensor w, int stride, bool gradmode = false) {
            Functions.ComplexConvolution.ComplexConvolution3D function =
                new Functions.ComplexConvolution.ComplexConvolution3D(x.Shape, w.Shape, stride, gradmode);
...
namespace TensorShader.Functions.ComplexConvolution {
    /// <summary>複素3次元畳み込み</summary>
    internal class ComplexConvolution3D : Function {
        ...
        public ComplexConvolution3D(Shape inshape, Shape kernelshape, int stride, bool gradmode) :
            ...
            this.OutShape = Shape.Map3D(kernelshape.OutChannels * 2, outwidth, outheight, outdepth, inshape.Batch);
        ...
        internal override (Tensor[] tensors, Operator ope) GenerateOperator(Tensor[] intensors, Tensor[] outtensors) {
            ...
            return (new Tensor[] { intensors[0], intensors[1], outtensors[0] },
                    new Operators.ComplexConvolution.ComplexConvolution3D(
