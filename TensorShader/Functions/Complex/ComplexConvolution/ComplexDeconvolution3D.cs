...
namespace TensorShader.Functions.ComplexConvolution {
    /// <summary>複素3次元逆畳み込み</summary>
    internal class ComplexDeconvolution3D : Function {
        ...
        public ComplexDeconvolution3D(Shape outshape, Shape kernelshape, int stride, bool gradmode) :
            ...
            this.InShape = Shape.Map3D(kernelshape.OutChannels * 2, inwidth, inheight, indepth, outshape.Batch);
