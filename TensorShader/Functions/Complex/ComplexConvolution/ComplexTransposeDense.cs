...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode ComplexTransposeDense(VariableNode x, VariableNode w, bool gradmode = false) {
            Function function =
                new Functions.ComplexConvolution.ComplexTransposeDense(x.Shape, w.Shape, gradmode);
    ...
    public partial class Tensor {
        /// <summary>複素転置全結合</summary>
        public static Tensor ComplexTransposeDense(Tensor x, Tensor w, bool gradmode = false) {
            Functions.ComplexConvolution.ComplexTransposeDense function =
                new Functions.ComplexConvolution.ComplexTransposeDense(x.Shape, w.Shape, gradmode);
...
namespace TensorShader.Functions.ComplexConvolution {
    /// <summary>複素転置全結合</summary>
    internal class ComplexTransposeDense : Function {
        ...
        public ComplexTransposeDense(Shape inshape, Shape kernelshape, bool gradmode) :
        ...
        internal override (Tensor[] tensors, Operator ope) GenerateOperator(Tensor[] intensors, Tensor[] outtensors) {
            ...
            return (new Tensor[] { intensors[0], intensors[1], outtensors[0] },
                    new Operators.ComplexConvolution.ComplexTransposeDense(
