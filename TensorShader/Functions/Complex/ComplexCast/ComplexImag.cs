...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode ComplexImag(VariableNode x) {
            Function function = new Functions.Complex.ComplexImag();
    ...
    public partial class Tensor {
        /// <summary>複素虚部</summary>
        public static Tensor ComplexImag(Tensor x) {
            Function function = new Functions.Complex.ComplexImag();
...
namespace TensorShader.Functions.Complex {
    /// <summary>複素虚部</summary>
    internal class ComplexImag : Function {
        ...
        internal override (Tensor[] tensors, Operator ope) GenerateOperator(Tensor[] intensors, Tensor[] outtensors) {
            ...
            return (new Tensor[] { intensor, outtensor },
                    new Operators.ComplexCast.ComplexImag(intensor.Shape));
        }
    }
}
