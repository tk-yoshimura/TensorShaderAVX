...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode TrivectorY(VariableNode x) {
            Function function = new Functions.Trivector.TrivectorY();
    ...
    public partial class Tensor {
        /// <summary>3次元ベクトルY成分</summary>
        public static Tensor TrivectorY(Tensor x) {
            Function function = new Functions.Trivector.TrivectorY();
    ...
    internal class TrivectorY : Function {
        ...
        internal override (Tensor[] tensors, Operator ope) GenerateOperator(Tensor[] intensors, Tensor[] outtensors) {
            ...
            return (new Tensor[] { intensor, outtensor },
                    new Operators.TrivectorCast.TrivectorY(intensor.Shape));
        }
    }
}
