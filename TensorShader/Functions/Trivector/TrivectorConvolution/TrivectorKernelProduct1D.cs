...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode TrivectorKernelProduct1D(VariableNode x, VariableNode y, VariableNode q, int kwidth, int stride, bool transpose = false) {
            Function function =
                new Functions.TrivectorConvolution.TrivectorKernelProduct1D(x.Shape, y.Shape, kwidth, stride, transpose);
    ...
    public partial class Tensor {
        /// <summary>3次元ベクトル1次元カーネル積</summary>
        public static Tensor TrivectorKernelProduct1D(Tensor x, Tensor y, Tensor q, int kwidth, int stride, bool transpose = false) {
...
namespace TensorShader.Functions.TrivectorConvolution {
    ...
    internal class TrivectorKernelProduct1D : Function {
        ...
        public TrivectorKernelProduct1D(Shape inshape, Shape outshape, int kwidth, int stride, bool transpose) :
