...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode TrivectorDeconvolution1D(VariableNode x, VariableNode w, int stride, bool gradmode = false, Shape outshape = null) {
            if (outshape == null) {
                int outwidth = (x.Shape.Width - 1) * stride + w.Shape.Width;

                outshape = Shape.Map1D(w.Shape.InChannels / 4 * 3, outwidth, x.Shape.Batch);
            }

            Function function =
                new Functions.TrivectorConvolution.TrivectorDeconvolution1D(outshape, w.Shape, stride, gradmode);
    ...
    public partial class Tensor {
        /// <summary>3次元ベクトル1次元逆畳み込み</summary>
        public static Tensor TrivectorDeconvolution1D(Tensor x, Tensor w, int stride, bool gradmode = false, Shape outshape = null) {
            if (outshape == null) {
                int outwidth = (x.Shape.Width - 1) * stride + w.Shape.Width;
            ...
            Functions.TrivectorConvolution.TrivectorDeconvolution1D function =
                new Functions.TrivectorConvolution.TrivectorDeconvolution1D(outshape, w.Shape, stride, gradmode);
...
namespace TensorShader.Functions.TrivectorConvolution {
    /// <summary>3次元ベクトル1次元逆畳み込み</summary>
    internal class TrivectorDeconvolution1D : Function {
        ...
        public TrivectorDeconvolution1D(Shape outshape, Shape kernelshape, int stride, bool gradmode) :
            ...
            this.InShape = Shape.Map1D(kernelshape.OutChannels * 3, inwidth, outshape.Batch);
        ...
        internal override (Tensor[] tensors, Operator ope) GenerateOperator(Tensor[] intensors, Tensor[] outtensors) {
            ...
            return (new Tensor[] { intensors[0], intensors[1], outtensors[0] },
                    new Operators.TrivectorConvolution.TrivectorDeconvolution1D(
                        OutShape.Width,
