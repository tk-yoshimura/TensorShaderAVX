...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode TrivectorConvolution2D(VariableNode x, VariableNode w, int stride, bool gradmode = false) {
            Function function =
                new Functions.TrivectorConvolution.TrivectorConvolution2D(x.Shape, w.Shape, stride, gradmode);
    ...
    public partial class Tensor {
        /// <summary>3次元ベクトル2次元畳み込み</summary>
        public static Tensor TrivectorConvolution2D(Tensor x, Tensor w, int stride, bool gradmode = false) {
...
namespace TensorShader.Functions.TrivectorConvolution {
    ...
    internal class TrivectorConvolution2D : Function {
        ...
        public TrivectorConvolution2D(Shape inshape, Shape kernelshape, int stride, bool gradmode) :
