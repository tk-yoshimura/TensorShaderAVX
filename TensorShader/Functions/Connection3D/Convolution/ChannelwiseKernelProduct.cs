...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode ChannelwiseKernelProduct3D(VariableNode x, VariableNode y, int kwidth, int kheight, int kdepth, int stride) {
            Function function =
                new Functions.Connection3D.ChannelwiseKernelProduct(x.Shape, y.Shape, kwidth, kheight, kdepth, stride);
    ...
    public partial class Tensor {
        /// <summary>チャネルごとの3次元カーネル積</summary>
        public static Tensor ChannelwiseKernelProduct3D(Tensor x, Tensor y, int kwidth, int kheight, int kdepth, int stride) {
...
namespace TensorShader.Functions.Connection3D {
    ...
    internal class ChannelwiseKernelProduct : Function {
        ...
        public ChannelwiseKernelProduct(Shape inshape, Shape outshape, int kwidth, int kheight, int kdepth, int stride) :
