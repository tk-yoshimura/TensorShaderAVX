...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode BilinearZoom3D(VariableNode x) {
            Function function =
                new Functions.Connection3D.BilinearZoom();
    ...
    public partial class Tensor {
        /// <summary>3次元バイリニア補間</summary>
        /// <remarks>倍率2固定</remarks>
        public static Tensor BilinearZoom3D(Tensor x) {
            Function function =
                new Functions.Connection3D.BilinearZoom();
    ...
    internal class BilinearZoom : Function {
        ...
        internal override (Tensor[] tensors, Operator ope) GenerateOperator(Tensor[] intensors, Tensor[] outtensors) {
            ...
            return (new Tensor[] { intensors[0], outtensors[0] },
                    new Operators.Connection3D.BilinearZoom(
