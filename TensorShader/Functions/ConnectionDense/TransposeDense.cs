...
namespace TensorShader {
    public abstract partial class VariableNode {
        ...
        public static VariableNode TransposeDense(VariableNode x, VariableNode w) {
            Function function =
...
namespace TensorShader.Functions.ConnectionDense {
    /// <summary>転置全結合</summary>
    internal class TransposeDense : Function {
        ...
        internal override (Tensor[] tensors, Operator ope) GenerateOperator(Tensor[] intensors, Tensor[] outtensors) {
            ...
            return (new Tensor[] { intensors[0], intensors[1], outtensors[0] },
                    new Operators.ConnectionDense.TransposeDense(
