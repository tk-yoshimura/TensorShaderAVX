...
namespace TensorShader {
    public partial class Field {
        ...
        public static Field ZeroPadding2D(Field x, int pad) {
            Field y = new Field();
            Link link = new Links.Connection2D.ZeroPadding(x, y, pad);
        ...
        /// <summary>2次元ゼロパディング</summary>
        public static Field ZeroPadding2D(Field x, int pad_left, int pad_right, int pad_top, int pad_bottom) {
            Field y = new Field();
            Link link = new Links.Connection2D.ZeroPadding(x, y, pad_left, pad_right, pad_top, pad_bottom);
...
namespace TensorShader.Links.Connection2D {
    ...
    public class ZeroPadding : Link {
        ...
        public override void Forward() {
            Y.AssignValue(ZeroPadding2D(X.Value, PadLeft, PadRight, PadTop, PadBottom));
        }
