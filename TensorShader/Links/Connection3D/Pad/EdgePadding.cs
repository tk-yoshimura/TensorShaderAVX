...
namespace TensorShader.Links.Connection3D {
    ...
    public class EdgePadding : Link {
        ...
        /// <summary>コンストラクタ</summary>
        public EdgePadding(Field infield, Field outfield, int pad_left, int pad_right, int pad_top, int pad_bottom, int pad_front, int pad_rear)
        ...
        public override void Forward() {
            Y.AssignValue(EdgePadding3D(X.Value, PadLeft, PadRight, PadTop, PadBottom, PadFront, PadRear));
        }
