...
namespace TensorShader.Operators.Indexer {
    ...
    internal class ArgMin : Operator {
        ...
        public ArgMin(int channels, int batch = 1) {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Indexer.ArgMin((uint)outmap.Length, (uint)Channels, inmap.Buffer, outmap.Buffer);
        }
