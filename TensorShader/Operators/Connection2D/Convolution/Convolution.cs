...
namespace TensorShader.Operators.Connection2D {
    ...
    internal class Convolution : Operator {
        ...
        public Convolution(int inwidth, int inheight, int inchannels, int outchannels, int kwidth, int kheight, int stride, int batch = 1) {
            if (stride < 1) {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            Parallel.For(0, Batch, (th) => {
                TensorShaderAvxBackend.Convolution.Convolution2D((uint)InChannels, (uint)OutChannels,
