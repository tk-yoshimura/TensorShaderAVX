...
namespace TensorShader.Operators.Connection2D {
    ...
    internal class ChannelwiseConvolution : Operator {
        ...
        public ChannelwiseConvolution(int inwidth, int inheight, int channels, int kwidth, int kheight, int batch = 1) {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Convolution.ChannelwiseConvolution2D((uint)Channels,
