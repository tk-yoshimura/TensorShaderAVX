...
namespace TensorShader.Operators.Connection2D {
    ...
    internal class SpaceToChannel : Operator {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Transform.SpaceToChannel2D((uint)InChannels, (uint)outmap.Width, (uint)outmap.Height, (uint)Batch, (uint)Scale, inmap.Buffer, outmap.Buffer);
        }
