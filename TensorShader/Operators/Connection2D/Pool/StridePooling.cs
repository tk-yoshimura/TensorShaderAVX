...
namespace TensorShader.Operators.Connection2D {
    ...
    internal class StridePooling : Operator {
        ...
        public StridePooling(int inwidth, int inheight, int channels, int stride, int batch = 1) {
            if (stride < 2) {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            //TensorShaderAvxBackend.Pool.StridePool2D((uint)Channels, (uint)inmap.Width, (uint)inmap.Height, (uint)Batch, (uint)Stride, inmap.Buffer, outmap.Buffer);
        }
