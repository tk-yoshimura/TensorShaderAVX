...
namespace TensorShader.Operators.QuaternionCast {
    ...
    internal class QuaternionPureJ : Operator {
        /// <summary>形状</summary>
        public Shape Shape { private set; get; }

        /// <summary>コンストラクタ</summary>
        public QuaternionPureJ(Shape inshape) {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Quaternion.PureJ((uint)outmap.Length, inmap.Buffer, outmap.Buffer);
        }
