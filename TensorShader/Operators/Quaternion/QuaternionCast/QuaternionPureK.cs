...
namespace TensorShader.Operators.QuaternionCast {
    ...
    internal class QuaternionPureK : Operator {
        /// <summary>形状</summary>
        public Shape Shape { private set; get; }

        /// <summary>コンストラクタ</summary>
        public QuaternionPureK(Shape inshape) {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Quaternion.PureK((uint)outmap.Length, inmap.Buffer, outmap.Buffer);
        }
