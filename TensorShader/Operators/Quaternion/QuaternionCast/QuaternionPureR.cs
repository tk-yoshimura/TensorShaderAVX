...
namespace TensorShader.Operators.QuaternionCast {
    ...
    internal class QuaternionPureR : Operator {
        /// <summary>形状</summary>
        public Shape Shape { private set; get; }

        /// <summary>コンストラクタ</summary>
        public QuaternionPureR(Shape inshape) {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Quaternion.PureR((uint)outmap.Length, inmap.Buffer, outmap.Buffer);
        }
