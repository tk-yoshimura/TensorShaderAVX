...
namespace TensorShader.Operators.QuaternionConvolution {
    ...
    internal class QuaternionConvolution3D : Operator {
        ...
        public QuaternionConvolution3D(int inwidth, int inheight, int indepth, int inchannels, int outchannels, int kwidth, int kheight, int kdepth, bool gradmode = false, int batch = 1) {
            if (inchannels % 4 != 0) {
