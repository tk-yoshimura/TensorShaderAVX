...
namespace TensorShader.Operators.QuaternionConvolution {
    ...
    internal class QuaternionKernelProduct1D : Operator {
        ...
        public QuaternionKernelProduct1D(int inwidth, int inchannels, int outchannels, int kwidth, bool transpose = false, int batch = 1) {
            if (inchannels % 4 != 0) {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Quaternion.KernelProduct1D((uint)InChannels, (uint)OutChannels,
                                                               (uint)inmap1.Width,
                                                               (uint)Batch,
                                                               (uint)KernelWidth,
                                                               Transpose,
