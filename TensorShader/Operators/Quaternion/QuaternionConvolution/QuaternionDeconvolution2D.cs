...
namespace TensorShader.Operators.QuaternionConvolution {
    ...
    internal class QuaternionDeconvolution2D : Operator {
        ...
        public QuaternionDeconvolution2D(int inwidth, int inheight, int inchannels, int outchannels, int kwidth, int kheight, bool gradmode = false, int batch = 1) {
            if (inchannels % 4 != 0) {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Quaternion.Deconvolution2D((uint)InChannels, (uint)OutChannels,
