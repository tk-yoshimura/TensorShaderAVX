...
namespace TensorShader.Operators.TrivectorConvolution {
    ...
    internal class TrivectorDeconvolution2D : Operator {
        ...
        public TrivectorDeconvolution2D(int outwidth, int outheight, int inchannels, int outchannels, int kwidth, int kheight, int stride, bool gradmode = false, int batch = 1) {
            if (stride < 1) {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            Parallel.For(0, Batch, (th) => {
                TensorShaderAvxBackend.Trivector.Deconvolution2D((uint)InChannels, (uint)OutChannels, 
