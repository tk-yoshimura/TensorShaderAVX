...
namespace TensorShader.Operators.TrivectorConvolution {
    ...
    internal class TrivectorConvolution1D : Operator {
        ...
        public TrivectorConvolution1D(int inwidth, int inchannels, int outchannels, int kwidth, bool gradmode = false, int batch = 1) {
            if (inchannels % 3 != 0) {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Trivector.Convolution1D((uint)InChannels, (uint)OutChannels,
                                                            (uint)inmap.Width,
                                                            (uint)Batch,
                                                            (uint)KernelWidth,
                                                            GradMode,
