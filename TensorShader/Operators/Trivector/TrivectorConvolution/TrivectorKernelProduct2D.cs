...
namespace TensorShader.Operators.TrivectorConvolution {
    ...
    internal class TrivectorKernelProduct2D : Operator{
        ...
        public TrivectorKernelProduct2D(int inwidth, int inheight, int inchannels, int outchannels, int kwidth, int kheight, int stride, bool transpose = false, int batch = 1){
            if (stride < 1) {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            Parallel.For(0, OutChannels / 3, (outch) => {
                TensorShaderAvxBackend.Trivector.KernelProduct2D((uint)InChannels, (uint)OutChannels, 
