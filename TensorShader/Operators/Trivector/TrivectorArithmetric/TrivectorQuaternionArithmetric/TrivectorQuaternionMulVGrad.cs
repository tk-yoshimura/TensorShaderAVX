...
namespace TensorShader.Operators.TrivectorQuaternionArithmetric {
    ...
    internal class TrivectorQuaternionMulVGrad : Operator {
        /// <summary>形状</summary>
        public Shape Shape { private set; get; }

        /// <summary>コンストラクタ</summary>
        public TrivectorQuaternionMulVGrad(Shape vectorshape) {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Trivector.MulVGrad(0, 0, (uint)inmap1.Length, inmap1.Buffer, inmap2.Buffer, outmap.Buffer);
        }
