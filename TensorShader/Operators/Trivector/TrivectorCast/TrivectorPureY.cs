...
namespace TensorShader.Operators.TrivectorCast {
    ...
    internal class TrivectorPureY : Operator {
        /// <summary>形状</summary>
        public Shape Shape { private set; get; }

        /// <summary>コンストラクタ</summary>
        public TrivectorPureY(Shape inshape) {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Trivector.PureY((uint)outmap.Length, inmap.Buffer, outmap.Buffer);
        }
