...
namespace TensorShader.Operators.TrivectorCast {
    ...
    internal class TrivectorPureX : Operator {
        /// <summary>形状</summary>
        public Shape Shape { private set; get; }

        /// <summary>コンストラクタ</summary>
        public TrivectorPureX(Shape inshape) {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Trivector.PureX((uint)outmap.Length, inmap.Buffer, outmap.Buffer);
        }
