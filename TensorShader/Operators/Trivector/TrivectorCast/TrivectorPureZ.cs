...
namespace TensorShader.Operators.TrivectorCast {
    ...
    internal class TrivectorPureZ : Operator {
        /// <summary>形状</summary>
        public Shape Shape { private set; get; }

        /// <summary>コンストラクタ</summary>
        public TrivectorPureZ(Shape inshape) {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Trivector.PureZ((uint)outmap.Length, inmap.Buffer, outmap.Buffer);
        }
