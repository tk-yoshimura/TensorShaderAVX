...
namespace TensorShader.Operators.ConnectionDense {
    ...
    internal class KernelProduct : Operator{
        ...
        public KernelProduct(int inchannels, int outchannels, int batch = 1){
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            Parallel.For(0, OutChannels, (outch) => {
                TensorShaderAvxBackend.Convolution.KernelProductDense((uint)InChannels, (uint)OutChannels, (uint)Batch, (uint)outch, inmap1.Buffer, inmap2.Buffer, outfilter.Buffer);
            });
        }
