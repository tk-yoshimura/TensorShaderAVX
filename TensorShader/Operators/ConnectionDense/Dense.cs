...
namespace TensorShader.Operators.ConnectionDense {
    ...
    internal class Dense : Operator {
        ...
        public Dense(int inchannels, int outchannels, int batch = 1) {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            Parallel.For(0, Batch, (th) => {
                TensorShaderAvxBackend.Convolution.Dense((uint)InChannels, (uint)OutChannels, (uint)Batch, (uint)th, inmap.Buffer, infilter.Buffer, outmap.Buffer);
            });
        }
