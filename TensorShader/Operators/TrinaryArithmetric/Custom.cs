namespace TensorShader.Operators.TrinaryArithmetric {
    ...
    internal class CustomTrinaryArithmetric : TrinaryArithmetric {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Elementwise.TrinaryArithmetric((uint)Shape.Length, inmap1.Buffer, inmap2.Buffer, inmap3.Buffer, outmap.Buffer, funcname, funccode);
        }
    }
    ...
    internal class CustomTrinaryUniConstantArithmetric : TrinaryUniConstantArithmetric {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Elementwise.TrinaryUniConstantArithmetric((uint)Shape.Length, Constant, inmap1.Buffer, inmap2.Buffer, outmap.Buffer, funcname, funccode);
        }
    }
    ...
    internal class CustomTrinaryBiConstantArithmetric : TrinaryBiConstantArithmetric {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Elementwise.TrinaryBiConstantArithmetric((uint)Shape.Length, Constant1, Constant2, inmap.Buffer, outmap.Buffer, funcname, funccode);
        }
    }
}
