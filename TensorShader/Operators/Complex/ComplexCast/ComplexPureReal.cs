...
namespace TensorShader.Operators.ComplexCast {
    ...
    internal class ComplexPureReal : Operator {
        /// <summary>形状</summary>
        public Shape Shape { private set; get; }

        /// <summary>コンストラクタ</summary>
        public ComplexPureReal(Shape inshape) {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Complex.PureReal((uint)outmap.Length, inmap.Buffer, outmap.Buffer);
        }
