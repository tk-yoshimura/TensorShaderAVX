    ...
    internal class ComplexKernelProductDense : Operator{
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            Parallel.For(0, OutChannels / 2, (outch) => {
                TensorShaderAvxBackend.Complex.KernelProductDense((uint)InChannels, (uint)OutChannels, (uint)Batch, (uint)outch * 2, Transpose, inmap1.Buffer, inmap2.Buffer, outfilter.Buffer);
            });
        }
