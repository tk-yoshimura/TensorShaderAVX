...
namespace TensorShader.Operators.ComplexConvolution {
    ...
    internal class ComplexDeconvolution1D : Operator {
        ...
        public ComplexDeconvolution1D(int inwidth, int inchannels, int outchannels, int kwidth, bool gradmode = false, int batch = 1) {
            if (inchannels % 2 != 0) {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Complex.Deconvolution1D((uint)InChannels, (uint)OutChannels,
                                                            (uint)inmap.Width,
                                                            (uint)Batch,
                                                            (uint)KernelWidth,
                                                            GradMode,
