...
namespace TensorShader.Operators.ComplexConvolution {
    ...
    internal class ComplexDeconvolution3D : Operator {
        ...
        public ComplexDeconvolution3D(int inwidth, int inheight, int indepth, int inchannels, int outchannels, int kwidth, int kheight, int kdepth, bool gradmode = false, int batch = 1) {
            if (inchannels % 2 != 0) {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Complex.Deconvolution3D((uint)InChannels, (uint)OutChannels,
