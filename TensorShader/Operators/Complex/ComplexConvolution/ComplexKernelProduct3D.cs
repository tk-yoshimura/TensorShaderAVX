...
namespace TensorShader.Operators.ComplexConvolution {
    ...
    internal class ComplexKernelProduct3D : Operator {
        ...
        public ComplexKernelProduct3D(int inwidth, int inheight, int indepth, int inchannels, int outchannels, int kwidth, int kheight, int kdepth, bool transpose = false, int batch = 1) {
            if (inchannels % 2 != 0) {
