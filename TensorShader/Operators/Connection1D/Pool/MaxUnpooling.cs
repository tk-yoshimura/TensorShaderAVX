...
namespace TensorShader.Operators.Connection1D {
    ...
    internal class MaxUnpooling : Operator {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Pool.MaxUnpool1D((uint)Channels, (uint)outmap.Width, (uint)Batch, (uint)Stride, gradmap.Buffer, poolmap.Buffer, valmap.Buffer, outmap.Buffer);
        }
