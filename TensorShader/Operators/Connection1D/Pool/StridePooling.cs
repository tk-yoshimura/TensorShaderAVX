...
namespace TensorShader.Operators.Connection1D {
    ...
    internal class StridePooling : Operator {
        ...
        public StridePooling(int inwidth, int channels, int stride, int batch = 1) {
            if (stride < 2) {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            //TensorShaderAvxBackend.Pool.StridePool1D((uint)Channels, (uint)inmap.Width, (uint)Batch, (uint)Stride, inmap.Buffer, outmap.Buffer);
        }
