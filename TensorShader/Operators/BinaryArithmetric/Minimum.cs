namespace TensorShader.Operators.BinaryArithmetric {
    ...
    internal class Minimum : BinaryArithmetric {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Elementwise.Minimum(0, (uint)Shape.Length, inmap1.Buffer, inmap2.Buffer, outmap.Buffer);
        }
    }
    ...
    internal class MinimumConstant : BinaryRightConstantArithmetric {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Elementwise.MinimumConstant(0, (uint)Shape.Length, Constant, inmap.Buffer, outmap.Buffer);
        }
    }
}
