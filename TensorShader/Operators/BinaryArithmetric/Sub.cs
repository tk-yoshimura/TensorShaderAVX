namespace TensorShader.Operators.BinaryArithmetric {
    ...
    internal class SubLeftVector : BinaryLeftVectorArithmetric {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Channelwise.SubLVector((uint)VectorShape.Length, (uint)MapShape.Length, inmap1.Buffer, inmap2.Buffer, outmap.Buffer);
        }
    }
    ...
    internal class SubRightVector : BinaryRightVectorArithmetric {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Channelwise.SubRVector((uint)VectorShape.Length, (uint)MapShape.Length, inmap2.Buffer, inmap1.Buffer, outmap.Buffer);
        }
    }
