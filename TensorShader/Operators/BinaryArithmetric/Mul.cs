namespace TensorShader.Operators.BinaryArithmetric {
    ...
    internal class Mul : BinaryArithmetric {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Elementwise.Mul((uint)Shape.Length, inmap1.Buffer, inmap2.Buffer, outmap.Buffer);
        }
    }
    ...
    internal class MulLeftConstant : BinaryLeftConstantArithmetric {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Elementwise.MulConstant((uint)Shape.Length, Constant, inmap.Buffer, outmap.Buffer);
        }
    }
