namespace TensorShader.Operators.BinaryArithmetric {
    ...
    internal class CustomBinaryArithmetric : BinaryArithmetric {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Elementwise.BinaryArithmetric((uint)Shape.Length, inmap1.Buffer, inmap2.Buffer, outmap.Buffer, funcname, funccode);
        }
    }
    ...
    internal class CustomBinaryConstantArithmetric : BinaryRightConstantArithmetric {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Elementwise.BinaryConstantArithmetric((uint)Shape.Length, Constant, inmap.Buffer, outmap.Buffer, funcname, funccode);
        }
    }
}
