namespace TensorShader.Operators.BinaryArithmetric {
    ...
    internal class Maximum : BinaryArithmetric {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Elementwise.Maximum(0, (uint)Shape.Length, inmap1.Buffer, inmap2.Buffer, outmap.Buffer);
        }
    }
    ...
    internal class MaximumConstant : BinaryRightConstantArithmetric {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Elementwise.MaximumConstant(0, (uint)Shape.Length, Constant, inmap.Buffer, outmap.Buffer);
        }
    }
}
