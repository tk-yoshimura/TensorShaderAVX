...
namespace TensorShader.Operators.ArrayManipulation {
    ...
    internal class InsertChannel : Operator {
        /// <summary>挿入先チャネル</summary>
        public int ChannelIndex { private set; get; }

        /// <summary>コンストラクタ</summary>
        public InsertChannel(Shape inshape, int channel_index, Shape outshape) {
            ...
            if (channel_index < 0 || channel_index >= outshape.Channels || inshape.Channels + channel_index > outshape.Channels) {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.ArrayManipulation.PatternCopy((uint)inmap.Channels, 0, (uint)outmap.Channels, (uint)ChannelIndex,
                                                           (uint)inmap.Channels, (uint)(outmap.Length / outmap.Channels), inmap.Buffer, outmap.Buffer);
        }
