...
namespace TensorShader.Operators.Connection3D {
    ...
    internal class AveragePooling : Operator {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Pool.AveragePool3D((uint)Channels, (uint)inmap.Width, (uint)inmap.Height, (uint)inmap.Depth, (uint)Batch, (uint)Stride, inmap.Buffer, outmap.Buffer);
        }
