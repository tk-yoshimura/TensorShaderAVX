...
namespace TensorShader.Operators.Connection3D {
    ...
    internal class MaxUnpooling : Operator {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Pool.MaxUnpool3D((uint)Channels, (uint)outmap.Width, (uint)outmap.Height, (uint)outmap.Depth, (uint)Batch, (uint)Stride, gradmap.Buffer, poolmap.Buffer, valmap.Buffer, outmap.Buffer);
        }
