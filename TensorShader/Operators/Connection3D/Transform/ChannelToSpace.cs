...
namespace TensorShader.Operators.Connection3D {
    ...
    internal class ChannelToSpace : Operator {
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Transform.ChannelToSpace3D((uint)OutChannels, (uint)inmap.Width, (uint)inmap.Height, (uint)inmap.Depth, (uint)Batch, (uint)Scale, inmap.Buffer, outmap.Buffer);
        }
