...
namespace TensorShader.Operators.Connection3D {
    ...
    internal class ColumnToImage : Operator {
        ...
        public ColumnToImage(int inwidth, int inheight, int indepth, int channels, int kwidth, int kheight, int kdepth, int batch = 1) {
            ...
            this.arguments = new List<(ArgumentType type, Shape shape)>{
                (ArgumentType.In, new Shape(ShapeType.Column, kwidth * kheight * kdepth, channels, inwidth, inheight, indepth, batch)),
        ...
        public override void Execute(params Tensor[] tensors) {
            ...
            TensorShaderAvxBackend.Transform.ColumnToImage3D(
