...
namespace TensorShaderTest.Operators.Quaternion {
    ...
    public class QuaternionConvolution2DTest {
                                ...
                                foreach (int stride in new int[] { 1, 2, 3 }) {
                                    foreach (int inwidth in new int[] { 8, 9, 13, 17 }) {
                                        foreach (int inheight in new int[] { 8, 9, 19, 23 }) {
                                            ...
                                            QuaternionConvolution2D ope = new QuaternionConvolution2D(inwidth, inheight, inchannels, outchannels, kwidth, kheight, stride, gradmode:false, batch);
                                    ...
                                    foreach (int stride in new int[] { 1, 2, 3 }) {
                                        foreach (int inwidth in new int[] { 8, 9, 13, 17 }) {
                                            foreach (int inheight in new int[] { 8, 9, 19, 23 }) {
                                                ...
                                                QuaternionConvolution2D ope = new QuaternionConvolution2D(inwidth, inheight, inchannels, outchannels, kwidth, kheight, stride, gradmode, batch);
        ...
        public void SpeedTest() {
            ...
            QuaternionConvolution2D ope = new QuaternionConvolution2D(inwidth, inheight, inchannels, outchannels, ksize, ksize, stride);
