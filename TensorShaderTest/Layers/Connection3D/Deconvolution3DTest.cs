...
namespace TensorShaderTest.Layers {
    [TestClass]
    public class Deconvolution3DTest {
        [TestMethod]
        public void ExecuteTest() {
            ...
            Layer layer = new Deconvolution3D(inchannels, outchannels, kwidth, kheight, kdepth, stride, use_bias:true, pad_mode:PaddingMode.Edge, "conv");
