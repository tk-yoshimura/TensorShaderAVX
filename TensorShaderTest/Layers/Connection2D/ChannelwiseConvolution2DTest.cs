...
namespace TensorShaderTest.Layers {
    [TestClass]
    public class ChannelwiseConvolution2DTest {
        [TestMethod]
        public void ExecuteTest() {
            ...
            Layer layer = new ChannelwiseConvolution2D(channels, kwidth, kheight, stride, use_bias:true, pad_mode:PaddingMode.Edge, "conv");
