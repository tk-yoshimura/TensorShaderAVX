...
namespace TensorShaderTest.Layers {
    ...
    public class TrivectorDeconvolution1DTest {
        ...
        public void ExecuteTest() {
            int inchannels = 9, outchannels = 12, inwidth = 13, kwidth = 3, stride = 2, batch = 7;

            VariableField x = new Tensor(Shape.Map1D(inchannels, inwidth, batch));

            Layer layer = new TrivectorDeconvolution1D(inchannels, outchannels, kwidth, stride, use_bias:true, pad_mode:PaddingMode.Edge, "conv");
