...
void TensorShaderAvxBackend::Zoom::NeighborZoom2D(unsigned int channels, unsigned int inwidth, unsigned int inheight, unsigned int batch, unsigned int th, cli::array<float>^ inmap, cli::array<float>^ outmap) {
