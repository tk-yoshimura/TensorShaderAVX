...
void TensorShaderAvxBackend::Zoom::LinearZoom3D(unsigned int channels, unsigned int inwidth, unsigned int inheight, unsigned int indepth, unsigned int batch, AvxArray<float>^ inmap, AvxArray<float>^ outmap) {
    ...
    linear_zoom_3d(channels, inwidth, inheight, indepth, outwidth, outheight, outdepth, batch, inmap_ptr, outmap_ptr);
}
