...
void TensorShaderAvxBackend::Zoom::LinearZoom1D(unsigned int channels, unsigned int inwidth, unsigned int batch, unsigned int th, AvxArray<float>^ inmap, AvxArray<float>^ outmap) {
