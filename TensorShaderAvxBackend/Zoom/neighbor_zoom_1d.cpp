...
void TensorShaderAvxBackend::Zoom::NeighborZoom1D(unsigned int channels, unsigned int inwidth, unsigned int batch, unsigned int th, cli::array<float>^ inmap, cli::array<float>^ outmap) {
