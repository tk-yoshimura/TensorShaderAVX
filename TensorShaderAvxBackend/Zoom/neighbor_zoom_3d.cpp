...
void TensorShaderAvxBackend::Zoom::NeighborZoom3D(unsigned int channels, unsigned int inwidth, unsigned int inheight, unsigned int indepth, unsigned int batch, unsigned int th, cli::array<float>^ inmap, cli::array<float>^ outmap) {
    ...
    neighbor_zoom_3d(channels, inwidth, inheight, indepth, outwidth, outheight, outdepth, th, inmap_ptr, outmap_ptr);
}
