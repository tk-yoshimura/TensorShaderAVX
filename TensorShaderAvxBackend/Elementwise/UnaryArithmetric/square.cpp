...
void square(unsigned int length, const float* __restrict src_ptr, float* __restrict dst_ptr) {
...
void TensorShaderAvxBackend::Elementwise::Square(unsigned int length, AvxArray<float>^ src, AvxArray<float>^ dst) {
