...
void TensorShaderAvxBackend::Channelwise::SubRVector(unsigned int vector_length, unsigned int map_length, cli::array<float>^ srcvector, cli::array<float>^ srcmap, cli::array<float>^ dstmap) {
