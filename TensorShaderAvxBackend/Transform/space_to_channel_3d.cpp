...
void TensorShaderAvxBackend::Transform::SpaceToChannel3D(unsigned int inchannels, unsigned int outwidth, unsigned int outheight, unsigned int outdepth, unsigned int batch, unsigned int scale, AvxArray<float>^ inmap, AvxArray<float>^ outmap) {
    ...
    space_to_channel_3d(inchannels, outchannels, inwidth, inheight, indepth, outwidth, outheight, outdepth, batch, scale, inmap_ptr, outmap_ptr);
}
