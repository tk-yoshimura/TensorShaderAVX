...
void TensorShaderAvxBackend::Transform::SpaceToChannel2D(unsigned int inchannels, unsigned int outwidth, unsigned int outheight, unsigned int batch, unsigned int scale, AvxArray<float>^ inmap, AvxArray<float>^ outmap) {
    ...
    space_to_channel_2d(inchannels, outchannels, inwidth, inheight, outwidth, outheight, batch, scale, inmap_ptr, outmap_ptr);
}
