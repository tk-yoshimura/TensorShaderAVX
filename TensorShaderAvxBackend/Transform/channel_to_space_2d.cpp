...
void TensorShaderAvxBackend::Transform::ChannelToSpace2D(unsigned int outchannels, unsigned int inwidth, unsigned int inheight, unsigned int batch, unsigned int scale, AvxArray<float>^ inmap, AvxArray<float>^ outmap) {
    ...
    channel_to_space_2d(inchannels, outchannels, inwidth, inheight, outwidth, outheight, scale, batch, inmap_ptr, outmap_ptr);
}
