...
void TensorShaderAvxBackend::Complex::RRelu(unsigned int index, unsigned int length, cli::array<float>^ src, cli::array<float>^ dst) {
    ...
    complex_rrelu(length, src_ptr + index, dst_ptr + index);
}