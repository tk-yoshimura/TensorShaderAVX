...
void complex_squash(unsigned int length, const float* __restrict src_ptr, float* __restrict dst_ptr) {
...
void TensorShaderAvxBackend::Complex::Squash(unsigned int length, AvxArray<float>^ src, AvxArray<float>^ dst) {
