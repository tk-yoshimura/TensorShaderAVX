...
void maxpool_3d(unsigned int channels, 
...
void TensorShaderAvxBackend::Pool::MaxPool3D(unsigned int channels, unsigned int inwidth, unsigned int inheight, unsigned int indepth, unsigned int batch, unsigned int stride, AvxArray<float>^ inmap, AvxArray<float>^ outmap) {
    ...
    maxpool_3d(channels, inwidth, inheight, indepth, batch, stride, inmap_ptr, outmap_ptr);
}
