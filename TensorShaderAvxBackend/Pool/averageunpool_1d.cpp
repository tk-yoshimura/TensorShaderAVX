...
void averageunpool_1d(unsigned int channels, unsigned int outwidth, unsigned int th, unsigned int stride, const float* __restrict inmap_ptr, float* outmap_ptr) {
