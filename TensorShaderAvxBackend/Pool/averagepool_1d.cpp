...
void broadcastpool_1d(unsigned int channels, unsigned int inwidth, unsigned int th, unsigned int stride, float* inmap_ptr, float* outmap_ptr) {
...
void TensorShaderAvxBackend::Pool::AveragePool1D(unsigned int channels, unsigned int inwidth, unsigned int batch, unsigned int th, unsigned int stride, cli::array<float>^ inmap, cli::array<float>^ outmap) {
