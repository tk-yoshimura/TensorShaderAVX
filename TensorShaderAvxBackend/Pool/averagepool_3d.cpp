...
void broadcastpool_3d(unsigned int channels, unsigned int inwidth, unsigned int inheight, unsigned int indepth, unsigned int th, unsigned int stride, float* inmap_ptr, float* outmap_ptr) {
...
void TensorShaderAvxBackend::Pool::AveragePool3D(unsigned int channels, unsigned int inwidth, unsigned int inheight, unsigned int indepth, unsigned int batch, unsigned int th, unsigned int stride, cli::array<float>^ inmap, cli::array<float>^ outmap) {
