...
void maxunpool_2d(unsigned int channels, unsigned int outwidth, unsigned int outheight, unsigned int th, unsigned int stride, float* ingrad_ptr, float* inpool_ptr, const float* __restrict inmap_ptr, float* outmap_ptr) {
