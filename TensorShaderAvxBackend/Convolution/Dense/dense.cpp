...
void dense(unsigned int inchannels, unsigned int outchannels, unsigned int batch, 
...
void TensorShaderAvxBackend::Convolution::Dense(unsigned int inchannels, unsigned int outchannels, unsigned int batch, 
    ...
    dense(inchannels, outchannels, batch, inmap_ptr, outmap_ptr, kernel_ptr);
}
