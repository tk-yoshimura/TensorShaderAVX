...
void dense(unsigned int inchannels, unsigned int outchannels, unsigned int th, const float* __restrict inmap_ptr, float* __restrict outmap_ptr, const float* __restrict kernel_ptr) {
...
void TensorShaderAvxBackend::Convolution::Dense(unsigned int inchannels, unsigned int outchannels, unsigned int batch, unsigned int th, 
    ...
    dense(inchannels, outchannels, th, inmap_ptr, outmap_ptr, kernel_ptr);
}
