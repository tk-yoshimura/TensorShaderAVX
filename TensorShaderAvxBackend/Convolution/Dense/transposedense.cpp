...
void transposedense(unsigned int inchannels, unsigned int outchannels, unsigned int batch, 
...
void TensorShaderAvxBackend::Convolution::TransposeDense(unsigned int inchannels, unsigned int outchannels, unsigned int batch, 
    ...
    transposedense(inchannels, outchannels, batch, inmap_ptr, outmap_ptr, kernel_ptr);
}
