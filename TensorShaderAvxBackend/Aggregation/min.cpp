...
void TensorShaderAvxBackend::Aggregation::Min(unsigned int src_length, AvxArray<float>^ src, unsigned int dst_length, AvxArray<float>^ dst, unsigned int slides) {
    ...
    if (dst_length <= 1) {
        min_1(src_length, src_ptr, dst_length, dst_ptr, slides);
    }
    else if (dst_length <= 2) {
        min_2(src_length, src_ptr, dst_length, dst_ptr, slides);
    }
    else if (dst_length <= 3) {
        min_3(src_length, src_ptr, dst_length, dst_ptr, slides);
    }
    else if (dst_length <= 4) {
        min_4(src_length, src_ptr, dst_length, dst_ptr, slides);
    }
    else if (dst_length <= 7) {
        min_5_7(src_length, src_ptr, dst_length, dst_ptr, slides);
    }
    else if (dst_length <= 8) {
        min_8(src_length, src_ptr, dst_length, dst_ptr, slides);
    }
    else {
        min_9_(src_length, src_ptr, dst_length, dst_ptr, slides);
    }
}