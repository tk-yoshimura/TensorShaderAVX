...
void max_1(unsigned int src_length, const float* __restrict src_ptr, 
...
void max_2(unsigned int src_length, const float* __restrict src_ptr, 
           unsigned int dst_length, float* __restrict dst_ptr, unsigned int slides) {
...
void max_3(unsigned int src_length, const float* __restrict src_ptr, 
           unsigned int dst_length, float* __restrict dst_ptr, unsigned int slides) {
...
void max_4(unsigned int src_length, const float* __restrict src_ptr, 
           unsigned int dst_length, float* __restrict dst_ptr, unsigned int slides) {
...
void max_5_7(unsigned int src_length, const float* __restrict src_ptr, 
             unsigned int dst_length, float* __restrict dst_ptr, unsigned int slides) {
...
void max_8(unsigned int src_length, const float* __restrict src_ptr, 
           unsigned int dst_length, float* __restrict dst_ptr, unsigned int slides) {
...
void max_9_(unsigned int src_length, const float* __restrict src_ptr, 
            unsigned int dst_length, float* __restrict dst_ptr, unsigned int slides) {
