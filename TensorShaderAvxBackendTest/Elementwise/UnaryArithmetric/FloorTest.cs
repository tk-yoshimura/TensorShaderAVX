    ...
    public class FloorTest {
        ...
        public void ExecuteTest() {
            ...
            for(int length = 0; length < 1000; length++) {
                ...
                Elementwise.Floor(1, (uint)length, x, y);

                for(int i = 1; i <= length; i++) {
                    Assert.AreEqual(Math.Floor(x[i]), y[i], 1e-3f, $"index:{i}");
                }
        ...
        public void DenormalizedTest() {
            ...
            Elementwise.Floor(0, (uint)x.Length, x, y);
        ...
        public void SpeedTest() {
            ...
            Elementwise.Floor(0, (uint)length, x, y);
