    ...
    public class LeakyReluGradTest {
        ...
        public void ExecuteTest() {
            ...
            for(int length = 0; length < 1000; length++) {
                ...
                Elementwise.LeakyReluGrad(1, (uint)length, 0.5f, x1, x2, y);
        ...
        public void DenormalizedTest() {
            ...
            Elementwise.LeakyReluGrad(0, (uint)x1.Length, 0.25f, x1, x2, y);
            ...
            Elementwise.LeakyReluGrad(0, (uint)x1.Length, 0.25f, x1, x3, y);
            ...
            Elementwise.LeakyReluGrad(0, (uint)x1.Length, 0.25f, x2, x1, y);
            ...
            Elementwise.LeakyReluGrad(0, (uint)x1.Length, 0.25f, x3, x1, y);
        ...
        public void SpeedTest() {
            ...
            Elementwise.LeakyReluGrad(0, (uint)length, 0.5f, x1, x2, y);
