    ...
    public class ReluTest {
        ...
        public void ExecuteTest() {
            ...
            for(int length = 0; length < 1000; length++) {
                ...
                Elementwise.Relu(1, (uint)length, x, y);

                for(int i = 1; i <= length; i++) {
                    Assert.AreEqual(Math.Max(0, x[i]), y[i], 1e-4f, $"index:{i}");
                }
        ...
        public void DenormalizedTest() {
            ...
            Elementwise.Relu(0, (uint)x.Length, x, y);
        ...
        public void SpeedTest() {
            ...
            Elementwise.Relu(0, (uint)length, x, y);
